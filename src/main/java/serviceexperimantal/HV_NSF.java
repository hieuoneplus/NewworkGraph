...
public class HV_NSF {
    public static String pathGA = "src/main/java/data/output/GA5/";
    public static String pathNSGA_II = "src/main/java/data/output/NSGA-II5/";

    public static String pathTest = "src/main/java/data/output/HV_NSF_result.txt";
